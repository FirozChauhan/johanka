...
/*
  ...
  server at POST /api/upload, which persists the catalog metadata in
  PostgreSQL. Thumbnails are generated by StreamTape itself once the video
  finishes processing — nothing to configure here.
*/
export default function UploadPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    // No credentials are sent — the server resolves StreamTape / Postgres
    // settings itself (env + the settings table). The client never holds the
    // config.
